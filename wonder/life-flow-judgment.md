...
**See also:** [Life game structure (nested instance, pills, daily loop)](life-game-structure.md) · [Lineage descent (talent, endowment, embodied social structure)](lineage-descent.md) · [Life arc (HUD runbook)](life-arc.md) · [Metaphors (comparison hub)](metaphors.md) · [Governance — ordered priorities](../plan/rules/governance.md)
