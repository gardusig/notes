...
This does **not** replace the full lifecycle in [`../../debug/README.md`](../../debug/README.md); it is the **bias**: when in doubt, **Plan + context first**, then Agent or hands-on work.
...
- [`../../craft-pr/work-task-with-agents.md`](../../craft-pr/work-task-with-agents.md) — execution, verify, chunking after the plan exists.
