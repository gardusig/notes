...
| File | Role |
| --- | --- |
| **[governance.md](governance.md)** | Ordered life stack, emotional triage (short), coarse risk tiers, thoughts vs execution, long arc — principles; links to sibling rule files. |
| **[priority.md](priority.md)** | P0–P4 execution, single top task, surfaces, onboarding, flow, habits — procedures. |
| **[plan-making.md](plan-making.md)** | When and how to plan (time-box, one outcome, stabilize first, surfaces, stop rule) for planning efficiency. |
| **[emotional-routing.md](emotional-routing.md)** | When spun up: what to open first, stabilization sequence. |
