...
**See also:** [plan-making.md](plan-making.md) (when and how to plan efficiently) · [Life flow and final judgment](../../wonder/life-flow-judgment.md) · [Metaphors (comparison hub)](../../wonder/metaphors.md) · [Life arc (HUD runbook)](../../wonder/life-arc.md) · [Tactical HUD](../../wonder/life-game-structure.md#tactical-hud) · [Opposite comparisons (spectra)](../../wonder/opposite-comparisons.md) · [Notes root README](../../README.md)

1. **Stay alive**
2. **Clarity (wisdom)** — think before acting
3. **Emotional control (patience)** — avoid impulsive mistakes
4. **Health** — enables everything
5. **Money** — buys optionality
...
- **High stakes** — health, safety, immigration, tax deadlines, anything with hard external dates.
- **Medium stakes** — money rhythm, employer commitments, backups.
- **Lower stakes** — hygiene, comfort, organizing, leisure.

When unsure, bias toward **writing the next step on a board** instead of holding the loop in your head.
...
**Narrative / metaphor layer** (main quest, HUD vs tactical state, paired values) — [life-arc.md](../../wonder/life-arc.md), [metaphors.md](../../wonder/metaphors.md), [opposite-comparisons.md](../../wonder/opposite-comparisons.md).
