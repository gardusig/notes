...
Lightweight capture for **what happened**, **body state**, and **which cognitive mode** you are in (review vs execute vs play). Extend this section with habits and spine detail as needed; picking rules at [`tasks/priority.md`](tasks/priority.md).
