...
| Folder | Apps |
| --- | --- |
| **Government** | **e-Título**, **FGTS**, **Gov.br**, **Meu SUS Digital** |
| **Travel** | **Airbnb**, **Booking**, **Google Maps**, **Uber**, **ClickBus**, **iFood**, **99** |
| **Entertainment** | **Kick**, **Stremio**, **Twitch**, **Google Files**, **YouTube**, **YouTube Music** — keep heavy offline files on removable/backup storage when supported and needed |
...
| **Meu SUS Digital** | SUS card, vaccine records, and public health appointments/notifications. |
