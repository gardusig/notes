...
- **Relationships and physical vitality** change across life seasons; what felt easy in one chapter may need more **intention** later. Invest honestly in **connection and health** while context allows—without pretending there is no cost in time, vulnerability, or tradeoffs.
...
Execution detail: [../plan/recurring.md](../plan/recurring.md), [../plan/rules/priority.md](../plan/rules/priority.md).
