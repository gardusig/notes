...
- Pair with [`../observe/prod-ui-flows.md`](../observe/prod-ui-flows.md) so you also capture **Network** facts (status, request id).
...
Link to this **`code/`** hub from tickets when you want collaborators (or future-you) to follow the same **patterns**, not the same **files** as the skill pack.
