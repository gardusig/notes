...
**Chess matches** are different: longer clock, you need **reasonable speed** on critical moments, and “not terrible” mistakes are more survivable than in single-move puzzle mode. Puzzles train **tactics under clarity**; games train **time + judgment under pressure**. Same opening book, different skill stack.
...
| --- | ---: |
| **Puzzle rating** | 1578 |
| **30-day high (puzzles)** | 1743 (2026-03-05) |
| **Rated puzzles — correct** | 1,791 |
| **Rated puzzles — incorrect** | 879 |
| **Accuracy (rated puzzles)** | ~67% correct |
| **Rated puzzle time** | 31h 6m *(training clock on site)* |
| **Puzzle Rush** | 17 *(separate mode)* |

*Recent rows on the site change daily; use the link above for live history.*
...
**Play:** you were **~500** stable; **next milestone 600+**. Ratings lag behavior—keep the habit and refresh numbers here when you close a week or month.
...
| --- | --- | --- | --- | --- |
| **Puzzle rating** | 2026-05-03 | 1578 | *(stepping stone)* | **~1750** stable |
| **Play rating** | | ~500 | **600+** | set after 600 holds |
