...
| **Good-enough description** | Turn it into a ticket or issue using [`../craft-issue/creativity/create-engineering-task.md`](../craft-issue/creativity/create-engineering-task.md): goal, scope in/out, acceptance criteria—even if some lines say **TBD** with a question. |
...
**Next:** [`next-priority-and-context.md`](next-priority-and-context.md)
