...
**Listening** — music (playlists, likes) is **[consume/playlists](../consume/playlists/README.md)**; podcasts and live feeds are **[consume/channels](../consume/channels/README.md)**.

Passive **video** (watched log, to-watch) and **reading** (books, wiki links for this library): **[consume/README.md](../consume/README.md)**.
