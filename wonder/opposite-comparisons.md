...
**See also:** [Life arc (HUD runbook)](life-arc.md) · [Metaphors (comparison hub)](metaphors.md) · [Governance — principles](../plan/rules/governance.md)
...
```mermaid
flowchart LR
  subgraph resp [After harm spectrum]
    fixPole[Fix and repair]
    midSpace[Justice proportion]
    venPole[Vengeance retaliate]
    fixPole --- midSpace --- venPole
  end
```
