...
- **Smoke test** critical paths in the target environment; compare with [`../../configure/work.md`](../../configure/work.md) *Verify deployed results*.
- If something looks wrong in prod UI, use [`../observe/prod-ui-flows.md`](../observe/prod-ui-flows.md) and keep dashboard / escalation links in [`configure/work.md`](../../configure/work.md).
