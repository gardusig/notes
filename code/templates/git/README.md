...
4. [`push-workflow.md`](push-workflow.md) — publish branch workflow notes.
5. [`reset-align-workflow.md`](reset-align-workflow.md) — hard reset align playbook.
6. [`start-branch-naming.md`](start-branch-naming.md) — branch naming from ticket or issue id.
7. [`zip-git-project-backup.md`](zip-git-project-backup.md) — `git archive` style backup naming.
