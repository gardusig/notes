...
| Publish and post-merge verify | [`quick-shipping-pattern.md`](quick-shipping-pattern.md), [`post-merge-checklist.md`](post-merge-checklist.md); team bookmarks in [`../../configure/work.md`](../../configure/work.md); prod UI tracing [`../observe/prod-ui-flows.md`](../observe/prod-ui-flows.md) | — |
