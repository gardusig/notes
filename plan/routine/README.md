...
| File | Role |
| --- | --- |
| **[weekly-rhythm.md](weekly-rhythm.md)** | Clock × weekday matrix (sleep, work blocks, chores). |
...
2. Morning routine  
3. Work — onboarding and task picking per [`../rules/priority.md`](../rules/priority.md)  
...
| --- | --- |
| Recovery block | Protect stability; avoid impulsive loops |
