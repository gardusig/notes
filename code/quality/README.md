...
**Scope:** Pre-merge **confidence**—review discipline, reading test evidence, definition of done. This is separate from [`../deploy/README.md`](../deploy/README.md) (release mechanics: patterns, post-merge checklist, lifecycle map).
...
- **Production tracing (after ship):** [`../observe/README.md`](../observe/README.md)
