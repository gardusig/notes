...
**Practical execution** (surfaces, pick-one-task, P0–P4) — [`../plan/rules/priority.md`](../plan/rules/priority.md) and [`../plan/README.md`](../plan/README.md); **principles** (ordered stack, emotional routing) — [`../plan/rules/governance.md`](../plan/rules/governance.md).
