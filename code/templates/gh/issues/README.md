...
4. [`dedupe-checklist.md`](dedupe-checklist.md) — pre-flight dedupe checklist.
5. [`delete-closed.md`](delete-closed.md) — bulk delete closed issues (destructive) shapes.
6. [`label-decorate.md`](label-decorate.md) — label list/match/create command shapes.
