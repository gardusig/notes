...
Team norms for spikes and design still align with [`../../setup/work.md`](../../setup/work.md) *Starting a new task (SDE2)*.

**Previous:** [`execute-from-plan.md`](execute-from-plan.md)
